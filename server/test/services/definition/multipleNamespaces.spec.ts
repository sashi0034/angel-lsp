...
describe('definition/multipleNamespaces', () => {
    it('resolves a namespace from an included file', () => {
        testDefinition([
            {
    ...
    it('resolves the nearest namespace declaration', () => {
        testDefinition([
            {
                uri: 'file:///path/to/file_0.as',
                content: `// Jump to the most appropriate namespace
    ...
    it('resolves namespace chains to the most appropriate declarations', () => {
        testDefinition(
