...
describe('completion/namespace', () => {
    ...
    it('completes deeply nested namespace members', () => {
        testCompletion(
    ...
    it('completes namespace members from included files', () => {
        testCompletion(
            [
                {
    ...
    it('completes class names in inherited namespace references', () => {
        testCompletion(
